...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HYLegacyComponents/HYLegacyComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HYSSignalKit/HYSSignalKit.framework"
